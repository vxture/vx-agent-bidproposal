...
- `bid.vxture.com.conf` - bid's prod vhost. This is the source of record: it
...
3. Verify: `curl https://bid.vxture.com/api/health` returns the app's payload
...
and rewrites the server names, but it does NOT touch the port - that is bid's
