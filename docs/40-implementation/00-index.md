...
| Doc | Covers |
|-----|--------|
| [10-app-workspace.md](10-app-workspace.md) | the pnpm workspace layout, `@bid/*` packages, local dev, and how the integration modules fit together |
| [20-creating-a-product-from-bid.md](20-creating-a-product-from-bid.md) | copying this repo into a new product: the rename script, the name cascade, and what a human still owns |
