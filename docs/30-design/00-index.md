...
bidproposal's domain is the platform integration surface itself, so its business-face
...
copied from bidproposal must not reuse them for its own domain data.
